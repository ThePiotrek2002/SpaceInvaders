...
ScreenCan.prototype.drawScoring = function (value: string, x: number, y: number) {
    this.ctx.font = "20px Pixel"
    this.ctx.fillStyle = "white"
    this.ctx.fillText(value, x, y)
}
...
var display: any, input: any, klatki: number, sprite_frame: number, level_frame: number;
var alien_sprite: any, tank_sprite: any, cities_sprite: any, explosion_sprite: any;
...
function main() {
    ...
    img.addEventListener("load", function () {
        ...
        tank_sprite = new (Sprite as any)(this, 62, 0, 22, 16);
        cities_sprite = new (Sprite as any)(this, 84, 8, 36, 24);
        explosion_sprite = new (Sprite as any)(this, 120, 16, 22, 15)
        init();
        run();
    });
